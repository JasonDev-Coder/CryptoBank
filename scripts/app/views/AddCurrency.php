...
<head>
    ...
    <link rel="stylesheet" href="/CryptoBank/scripts/css/addCurrency.css">
...
<body>
    <div class="container">
        ...
        <div class="right">
            <div class="formBox">
                <form action="/CryptoBank/scripts/public/Wallet_TypeController/addCurrency" method="POST" enctype="multipart/form-data">
                    <p>Name</p>
