  ...
  <div class="container">
    ...
    <main>
      <div class="main__container">
        ...
        <a href="/CryptoBank/scripts/public/adminRegForm"><Button class="add-admin">Add Admin</Button></a>
        ...
        foreach ($_SESSION["adminInfo"] as $k => $v) {
          echo "<tr><td>" . $v["user_id"] . "</td><td>" . $v["name"] . "</td>" 
               ...
               <a href='/CryptoBank/scripts/public/AdminController/removeAdmin/".$v["user_id"]."'>
