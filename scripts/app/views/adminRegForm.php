...
<head>
    ...
    <link rel="stylesheet" href="/CryptoBank/scripts/css/register.css">
    <script  src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    <script type="text/javascript" language="javascript" src="/CryptoBank/scripts/javascript/adminRegform.js"></script>
</head>

<body>
    <div class="container">
        <div class="left">
            <img class="btcImage" src="/CryptoBank/scripts/images/btcLogo.png" />
            <h2>Add Admin</h2>
        </div>
        <div class="right">
            <div class="formBox">
                <form id="adminRegForm" action="/CryptoBank/scripts/public/AdminController/adminRegister" method="POST">
                    <p>Name</p>
