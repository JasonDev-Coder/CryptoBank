  ...
  <div class="container">
    ...
    <main>
      <div class="main__container">
        ...
        <a href="/CryptoBank/scripts/public/AddCurrency"><Button class="add-admin">Add Currency</Button></a>
          ...
          foreach ($_SESSION["currenciesInfo"] as $k => $v) {
            echo "<tr><td>" . $v["type_id"] . "</td><td><img width=50 height=50 src='data:image/png;base64,".base64_encode($v['type_logo'])."'/></td>
              <td>" . $v["type_symbol"] . "</td><td>".$v["type_name"]."</td><td>
               <a href='/CryptoBank/scripts/public/Wallet_TypeController/removeCurrency/" . $v["type_id"] . "'>
