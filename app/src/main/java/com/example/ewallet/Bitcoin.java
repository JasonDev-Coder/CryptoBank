...
public class Bitcoin extends AppCompatActivity {
    ...
    private void parseMarketResponse(String body) {
        try {
            ...
            max_market_value.setText(Integer.toString(btc_info.getInt("max_supply"))+" Bitcoin");
            circ_sup_view.setText(Integer.toString(circ_cup_int)+" Bitcoin");
